...
app.post('/upload', (req, res, next) => {
  ...
  console.log(req.files.file.name); //original filename with extension
...
/* 	var filename = '${__dirname}/public/${req.files.file.name}';
	var extension = filename.search(/\.([a-z])\w+/i);
